using eSya.ConfigCalDoc.WebAPI.Filters;
using Microsoft.Extensions.Configuration;
using DL_ConfigCalDoc = eSya.ConfigCalDoc.DL.Entities;
using eSya.ConfigCalDoc.IF;
using eSya.ConfigCalDoc.DL.Repository;
using Microsoft.AspNetCore.Mvc;
using eSya.ConfigCalDoc.WebAPI.Utility;
using System.Globalization;
using eSya.ConfigCalDoc.DL.Localization;
...
DL_ConfigCalDoc.eSyaEnterprise._connString = builder.Configuration.GetConnectionString("dbConn_eSyaEnterprise");
